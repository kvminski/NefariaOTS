...
shopModule:addBuyableItem({'vortex bolt'}, 15649, 6, 1,'vortex bolt')
shopModule:addBuyableItem({'piercing bolt'}, 7363, 5, 1,'piercing bolt')
shopModule:addBuyableItem({'infernal bolt'}, 6529, 500, 1,'infernal bolt')
...
shopModule:addBuyableItem({'small stone'}, 1294, 20, 1,'small stone')
shopModule:addBuyableItem({'envenomed arrow'}, 18437, 12, 1,'envenomed arrow')
shopModule:addBuyableItem({'crystalline arrow'}, 18304, 20, 1,'crystalline arrow')
shopModule:addBuyableItem({'drill bolt'}, 18436, 12, 1,'drill bolt')
shopModule:addBuyableItem({'prismatic bolt'}, 18435, 20, 1,'prismatic bolt')
shopModule:addBuyableItem({'tarsal arrow'}, 15648, 6, 1,'tarsal arrow')
