...
local BOSS = "gnomevil"
local posGnome = {x=1065, y=1918, z=10}
local kickposs = {x=950, y=1867, z=8} 
local kickposs1 = {x=1047, y=1946, z=10} 

local function deGnomevil()
if(getGlobalStorageValue(91149) < 1) then
    TOP_LEFT_CORNER = {x = 1052, y = 1910, z = 10, stackpos=253}
    BOTTOM_RIGHT_CORNER = {x = 1080, y = 1938, z = 10, stackpos=253}
...
if(getGlobalStorageValue(99159) < 1) then
	doTeleportThing(cid, {x = 1055, y = 1923, z = 10})
...
elseif item.actionid == 5160 then
        doTeleportThing(cid, {x=950, y=1867, z=8})
		--else 
