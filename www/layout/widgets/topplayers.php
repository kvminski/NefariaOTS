								...
								<?php
									...
									if ($players) {
										...
										foreach($players as $player) {
											echo "<tr><td class='labelbox' width='50%'>$count - <a href='characterprofile.php?name=". $player['name']. "'>". $player['name']. "</a> <span class='label label-primary' style='float:right;'>Level: ". $player['level'] ."</span></td></<tr>";
											$count++;
										}
									}
									?>
