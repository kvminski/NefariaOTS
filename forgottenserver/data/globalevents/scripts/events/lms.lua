local centeroffight = {x = 920, y = 625, z = 9}
local waitingplace = {x = 897, y = 629, z = 9}
local depotcenter = {x = 1065, y = 1067, z = 7}
...
local function lmsclosed1()
    broadcastMessage("LMS event will start in 5 minutes. Portal is opened in north of depot Thais. The reward is 2 PREMIUM POINTS, Hurry!!", MESSAGE_STATUS_WARNING)
end
...
broadcastMessage("Not enough players to start Last man Standing event! Minimum: "..MinimumPlayers.." players.", MESSAGE_STATUS_WARNING)
...
local function lms()
    broadcastMessage("LMS event will start in 9 minutes. Portal is opened in Event Room. The reward is 2 PREMIUM POINTS, Hurry!!", MESSAGE_STATUS_WARNING)

    portalwhere = {x = 997, y = 856, z = 8}
...
function onTime()
    ...
    broadcastMessage("Last Man Standing event will start in 10 minutes.", MESSAGE_STATUS_WARNING)
