...
zeArenaFromPosition = Position(839, 619, 9) --pos of top left corner {x = 32442, y = 32522, z = 7}
zeArenaToPosition = Position(854, 638, 9) --pos of bottom right corner {x = 32457, y = 32538, z = 7}
...
local function warnEvents(i)
	Game.broadcastMessage("The Zombie event was opened, entrance through Event Room!")
	if i > 1 then
