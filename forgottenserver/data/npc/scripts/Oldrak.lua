	...
	if msgcontains(msg, 'mission') or msgcontains(msg, 'demon oak') then
		...
		elseif player:getStorageValue(Storage.DemonOak.Done) == 1 then
			npcHandler:say({
				...
				"For your brave action, I tell you a secret which has been kept for many many years. There is the cave north of the location where you found the demon oak. There should be a grave with the name 'Yesim Adeit' somewhere close by. ...",
