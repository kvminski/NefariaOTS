...
SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position(670, 537, 6),
	rewardPosition = Position(669, 524, 6),
...
local firstPit = {
	fromPos = {x = 652, y = 538, z = 7},
	toPos = {x = 661, y = 547, z = 7},
	center = {x = 657, y = 542, z = 7},
	pillar = {x = 651, y = 542, z = 7},
	tp = {x = 651, y = 542, z = 7},
	summon = {x = 657, y = 544, z = 7}
}
